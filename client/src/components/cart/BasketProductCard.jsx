    ...
    <div className="relative flex justify-between items-center mb-4 border p-4 rounded">
      <div className="flex items-start">
        <div className="flex flex-col items-center mr-4">
          <img src={item.imageURL || '/public/images/hero-one.jfif'} alt={item.name} className="w-16 h-16 object-cover mb-2" />
      ...
      <div className="flex flex-col items-end">
        <button
          onClick={() => deleteCartItem(item.urlSlug)}
...
BasketProductCard.propTypes = {
  item: PropTypes.shape({
    ...
    imageURL: PropTypes.string, // Use imageURL instead of image
  }).isRequired,
